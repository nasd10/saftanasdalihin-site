...
function ContactSection() {
  ...
  const handleSubmit = (e) => {
    ...
    // Contoh: Formspree, Netlify Forms, atau backend kustom Anda sendiri.
    // Untuk saat ini, kita hanya akan log data ke konsol.
  ...
  return (
    <section id="contact" className="relative py-20 px-4 md:px-12 text-white overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <h2 className="text-5xl md:text-6xl font-bold text-center mb-16 text-violet-500 animate-fade-in-up">
          Get In Touch
        </h2>
